...
class _AsphalteScreenState extends State<AsphalteScreen> {
  ...
  void initState() {
    ...
    if (widget.asphalteData != null) {
      ...
      nouvelleInfraController.text = widget.asphalteData!.nouvelleInfra;
      positionnementController.text = widget.asphalteData!.positionnement;
      type_of_wasteController.text = widget.asphalteData!.typeOfWaste;
      poucesasphalteController.text = widget.asphalteData!.poucesAsphalte.toString();
      contourenPaveController.text = widget.asphalteData!.contourEnPave;
      type_of_plain_paversController.text = widget.asphalteData!.typeOfPlainPavers;
                ...
                child: Column(
                  children: [
                    ...
                    RegisterTextFieldWidget(
                      ...
                      // length: 10,
                      validator: MultiValidator([
                        RequiredValidator(errorText: 'Please enter your Pouces asphalte'.tr),
                      ]).call,
                      keyboardType: TextInputType.number,
                      // textInputAction: TextInputAction.next,
                      hint: '2',
                    ...
                    RegisterTextFieldWidget(
                      ...
                      // length: 10,
                      validator: MultiValidator([
                        RequiredValidator(errorText: 'Please enter your Type de pavé uni'.tr),
                      ]).call,
                    ...
                    RegisterTextFieldWidget(
                      ...
                      // length: 10,
                      validator: MultiValidator([
                        RequiredValidator(errorText: 'Please enter your Couleur de pavé'.tr),
                      ]).call,
                      // keyboardType: TextInputType.none,
                      // textInputAction: TextInputAction.next,
                      hint: 'gris',
                    ...
                    DottedBorder(
                      ...
                      child: InkWell(
                          ...
                          child: categoryFile.value.path == ""
                              ? widget.asphalteData != null && widget.asphalteData!.photoVideo != null
                              ? Container(
                            decoration: BoxDecoration(
                            ...
                            height: 180,
                            alignment: Alignment.center,
                            child: Image.network(widget.asphalteData!.photoVideo,
