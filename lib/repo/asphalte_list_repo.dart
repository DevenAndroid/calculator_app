...
import 'dart:io';
import 'package:calculator_app/model/asphalte_list_model.dart';
...
Future<Asphalte_list_model> asphalteListRepo({required clientId, required serviceType}) async {
  ...
  if (response.statusCode == 200 || response.statusCode == 400 )  {
    ...
    return Asphalte_list_model.fromJson(jsonDecode(response.body));
  } else {
    // Helper.hideLoader(loader);
