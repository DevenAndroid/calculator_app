...
Future<plates_bandes_model> platesbandesListRepo({required clientId, required serviceType}) async {
  ...
  if (response.statusCode == 200 || response.statusCode == 400 )  {
    ...
    return plates_bandes_model.fromJson(jsonDecode(response.body));
  } else {
    // Helper.hideLoader(loader);
