...
import '../model/drain_model.dart';
import '../model/muret_model.dart';
import '../widget/apiUrl.dart';
import '../widget/helper.dart';

class DrainScreenRepo {
  static Future<DrainScreenModel> drainScreenRepo({
    mapData,
    required fieldName1,
    ...
    try {
      ...
      var request =
      http.MultipartRequest('POST', Uri.parse(ApiUrl.drainScreenUrl));
      ...
      if (response.statusCode == 200 || response.statusCode == 400) {
        return DrainScreenModel.fromJson(
      ...
      return DrainScreenModel(message: "No Internet Access", status: false);
    } catch (e) {
      return DrainScreenModel(message: e.toString(), status: false);
    }
  }
