...
class AsphaltScreenRepo {
  static Future<AsphalteScreenModel> asphalteScreenRepo({
    mapData,
    required fieldName1,
    ...
    try {
      ...
      var request =
      http.MultipartRequest('POST', Uri.parse(ApiUrl.asphalteScreenUrl));
      ...
      if (response.statusCode == 200 || response.statusCode == 400) {
        return AsphalteScreenModel.fromJson(
      ...
      return AsphalteScreenModel(message: "No Internet Access", status: false);
    } catch (e) {
      return AsphalteScreenModel(message: e.toString(), status: false);
    }
  }
