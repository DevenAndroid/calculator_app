...
Future<CloturelistScreenModel> clotureListRepo({required clientId, required serviceType}) async {
  ...
  if (response.statusCode == 200 || response.statusCode == 400 )  {
    ...
    return CloturelistScreenModel.fromJson(jsonDecode(response.body));
  } else {
    // Helper.hideLoader(loader);
